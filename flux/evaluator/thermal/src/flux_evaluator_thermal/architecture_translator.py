...
genuinely separate NoC-style concern, `evaluator/booksim`'s own territory, not addressed here;
see evaluator/thermal/README.md). Material/heat-sink constants stay fixed, reused verbatim from
