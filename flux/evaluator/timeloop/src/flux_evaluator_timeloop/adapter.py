...
v0.1 status, mirroring evaluator/zigzag: Workload IR translation is unconditional
...
evaluates exactly one op per call"). Unlike `evaluator/zigzag`'s own multi-layer support (a
...
class TimeloopEvaluator(SequentialBatch):
    ...
    def _to_result(
        ...
        # Point estimates only, same v0.1 caveat as evaluator/zigzag: Timeloop reports single
