...
cost model — the escalation rung docs/calibration.md's diagram describes (analytic → RTL sim/synth
...
[docs/calibration.md](../../../docs/calibration.md) (the escalation-rung diagram this adapter is the first real
instance of), and
