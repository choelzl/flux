...
Verilator — the first *simulated*, not analytic, stage (docs/calibration.md's escalation diagram). Same
...
interchangeable at a stage, and it is the interface a new evaluator has to satisfy however its tool
is reached.
