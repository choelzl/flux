...
doesn't have, the same reasoning `evaluator/thermal` already applied to material constants
...
exact same representational gap `evaluator/booksim`'s own README already names and explains for
...
def architecture_ir_to_dramsim3_params(arch: dict[str, Any]) -> DramSim3Params:
    ...
    raise NotExpressibleError(
        ...
        "attrs.dramsim3_config set — evaluator/dramsim3 needs one, naming a real, bundled "
