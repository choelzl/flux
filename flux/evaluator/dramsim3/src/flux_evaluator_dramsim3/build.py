...
once, cache it" pattern every other heavy-external-tool adapter here uses (evaluator/booksim,
...
def _run(cmd: list[str], *, cwd: Path, timeout_s: float) -> ToolRun:
    ...
    return run_tool(cmd, cwd=cwd, timeout_s=timeout_s)
