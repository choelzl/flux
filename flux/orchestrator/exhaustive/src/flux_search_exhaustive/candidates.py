"""Generates flat-mapping candidates (docs/ir.md's Mapping IR) for a single-einsum-op
...
operands (no per-operand uneven mapping, no multi-level tiling yet — see evaluator/*/README.md).
...
class NotAFlatMappingCandidate(NotACandidate):
