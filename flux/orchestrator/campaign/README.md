...
- **Escalation** reuses the D105 machinery: stage-major cascade over the contender set through
  real higher-fidelity backends (verified against real Verilator), idempotent on resume,
  equal-fidelity frontier replacement only when a stage is complete.
