...
class AgenticMemorySearchReport:
    ...
    metric: str
    skipped_not_expressible: int      # one name across the five axes (D441)
    fallback_count: int
    iterations: int
    stopped_early: bool
    wall_clock_s: float
    ...
    @property
    def skipped_infeasible(self) -> int:
        """The name this axis's report used before D441."""
        return self.skipped_not_expressible
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "skipped_infeasible": self.skipped_not_expressible,
