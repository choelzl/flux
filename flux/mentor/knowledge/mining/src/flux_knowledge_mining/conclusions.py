...
from .lessons import THINGS

_ABSOLUTE = re.compile(
    rf"\b(unreachable|unattainable|impossible|never|no (?:{THINGS})|"
    rf"cannot be (?:achieved|reached|met)|not achievable|always|every (?:{THINGS})|"
