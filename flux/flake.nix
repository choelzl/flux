{
  description = ''
    Flux dev environment. No venv, no pip install step: `nix develop` alone works. Shells:
      ...
      - `physical` (linux): the OpenROAD place-and-route stage.
      ...
      devShells = forAllSystems (system:
        let
          ...
          basePythonPackages = ps: [
            ...
            # Direct deps of interfaces/chia_nodes, interfaces/mcp, search/agentic.
            ps.openai
            ps.uvicorn
          ];
          ...
          localSrcDirs = [
            ...
            "evaluator/cache/src"
            "applications/prefetcher/evaluator/src"
            "applications/prefetcher/codegen/src"
            ...
            "applications/interconnect/evaluator_struct/src"
            "applications/interconnect/evaluator_phys/src"
        ...
        // pkgs.lib.optionalAttrs pkgs.stdenv.isLinux {
          ...
          # The OpenROAD place-and-route stage (D225), with Verilator for the
        ...
        // {
          default = pkgs.mkShell {
            ...
            packages = [
              ...
              chipPkgs.verilator chipPkgs.sv-lang chipPkgs.yosys chipPkgs.gtkwave
