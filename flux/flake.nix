{
  description = ''
    ...
    (zigzag-dse), CHIA, Timeloop/Accelergy, Pythia/ChampSim and the EDA tools (Verilator,
      ...
      devShells = forAllSystems (system:
        let
          ...
          basePythonPackages = ps: [
            ...
            # Direct deps of interfaces/chia_nodes and interfaces/mcp.
            ps.openai
            ps.uvicorn
          ];
        ...
        // {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "flux dev shell: python + Verilator/Yosys/OpenROAD, Pythia/ChampSim"
