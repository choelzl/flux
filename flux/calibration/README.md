...
See [docs/04.md §5](../docs/04.md#5-l3--calibration-and-the-fidelity-ladder) and
[docs/03.md G2](../docs/03.md).
...
**Drift-detection CI** (`drift.py`): docs/04.md §5's "nightly re-evaluation of the calibration
...
**What "reference" means today, honestly:** docs/04.md §5 describes calibration against RTL
...
nowhere to go. It also only implements two of the three triggers docs/04.md §5 names (domain, CI
width) — not Pareto-front relevance, which needs a search-run context a single `Result` doesn't
have.

Not implemented: holdout-corpus enforcement, a synthesis-fidelity rung (Hammer) above RTL-sim.
