...
class Gradient:
    ...
    def observe(self, score: float, payload: Any, *, key: Any = None,
        ...
        the next edit is compared against (D470: the live NLU run's first refused prototype
        printed as "score inf (best so far)" and would have been reverted TO). It is not a
        regression either (D535, review §1.3.10): the tolerance is for edits measured WORSE,
        and a run of unmeasurable attempts is the prototype stage's own stop (D480, D484)."""
        f = self.fmt
