...
class EventBus:
    ...
    def task_end(self, task_id: int, *, ok: bool = True, note: str = "",
        ...
        wider than a parameter's: 200,000 characters holds an 80,000-token reply whole
        (D544: at 12,000 a streaming turn's thinking LOOKED cut off, and was not)."""
        clean = _bounded(output, _OUTPUT_CHARS)
        with self._lock:
