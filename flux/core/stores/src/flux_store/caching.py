...
The same wrapping pattern: any code
written against `evaluate`/`evaluate_batch` (a sweep, a search)
...
class CachingEvaluator:
    ...
    def evaluate_batch(
        ...
        evaluate_batch` in one call — so a concurrent evaluator wrapped underneath still gets
