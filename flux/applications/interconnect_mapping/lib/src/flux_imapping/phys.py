"""The physical stage: real Yosys+STA on ASAP7 for the pieces that set fmax and area.
...
is labeled composed and the whole-fabric OpenROAD flow remains the confirm stage.
"""
