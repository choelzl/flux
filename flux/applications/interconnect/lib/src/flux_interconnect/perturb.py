...
def has_path_choice(spec: dict[str, Any]) -> bool:
    ...
    unconditionally and wasted two of five on a single-path fabric; and the decision stage keyed
...
def structural_key(spec: dict[str, Any]) -> tuple:
    ...
    the proposer's repeat check, the proposer's validator, the decision stage's shortlist and the
