...
structural screen (`applications/interconnect/evaluator_struct`) and the physical stage
(`applications/interconnect/evaluator_phys`) build on one definition — the repo's one-directory-one-
...
from .abi_result import abi_result
from .loop import InterconnectProblem
