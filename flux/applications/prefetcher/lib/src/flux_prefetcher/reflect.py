...
The pairwise arithmetic moved to `flux_records.extract` (mentor/extract, D397) because it was
...
from flux_records.extract import Law as KnobInsight  # noqa: F401  (public API preserved)
from flux_records.extract import laws_text, pairwise_laws
...
def pairwise_insights(known: list[tuple[BingoConfig, float]], *, min_pairs: int = 2,
    ...
    """Knob-direction effects from every measured one-knob pair (see flux_records.extract)."""
