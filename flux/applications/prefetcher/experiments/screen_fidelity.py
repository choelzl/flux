...
the way the full run does, it is a screening stage and the search gets fifty times more reach for
...
sys.path.insert(0, str(FLUX_ROOT / "applications/prefetcher/evaluator/src"))
