...
#: THE TWO STAGES, and why instruction counts are not a caller's choice.
#:
...
#: how optimistic a stage is — a constant offset cancels in every comparison — but how much that
...
class ChampSimBingoEvaluator(SequentialBatch):
    ...
    """
    name = "champsim_bingo"   # the registry name (flux_evaluator_abi.registry, D426)
