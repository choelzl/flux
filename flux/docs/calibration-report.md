...
[docs/03.md G2](../docs/03.md) ranks calibration/uncertainty as the single highest-leverage gap
...
[docs/04.md §5](../docs/04.md#5-l3--calibration-and-the-fidelity-ladder) describes calibration
...
discipline exists to catch ([docs/05.md §3](05.md)): a pattern that looks solid on the training
...
`apply_escalation_policy()` ([docs/04.md §5](04.md)'s "spend high-fidelity budget where it
...
precisely the kind of bare-point-estimate overconfidence [docs/04.md §1](04.md)'s design
...
so this is exactly the kind of finding the field's tooling gap (docs/03.md G1, G4) predicts:
...
three points — the KPI table in [docs/05.md §4](05.md) sets a ≥90% CI-coverage target that this
cannot speak to yet.
...
`escalation.next_rung` and invokes it yet — that wiring (presumably a CHIA node, docs/04.md §5)
doesn't exist.
