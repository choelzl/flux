...
Same `Evaluator` interface (docs/evaluator-abi.md) as every other adapter — any code written against
...
CHIA. That's the point of docs/architecture.md's layering: L5 Search stays CHIA-agnostic; L6 Flows (this
