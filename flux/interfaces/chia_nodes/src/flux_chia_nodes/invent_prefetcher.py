...
The code-space stage. Everything else in the prefetcher study searches parameters of prefetchers
...
def flux_invent_prefetcher(
    *,
    ...
    # the expensive stage answers (D351).
    ...
    # verdict is not to be quoted, but "did not even beat it here" is enough to save the stage.
