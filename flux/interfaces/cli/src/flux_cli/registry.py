...
def _register_defaults() -> None:
    ...
    def _champsim_bingo() -> Any:
        from flux_evaluator_champsim_bingo import ChampSimBingoEvaluator

        return ChampSimBingoEvaluator()
    ...
    _BACKEND_FACTORIES["champsim_bingo"] = _champsim_bingo
