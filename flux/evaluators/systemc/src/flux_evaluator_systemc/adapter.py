"""SystemC coarse-grain backend adapter implementing the Flux Evaluator ABI (docs/04.md §4.4,
§5's fidelity ladder): a fast functional-correctness + timing pre-check for the exact same
