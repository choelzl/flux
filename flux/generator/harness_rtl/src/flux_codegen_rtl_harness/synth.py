...
in this repo (it's been a cherry-picked `.#default` nix package since `evaluator/rtl` needed
...
counts, checkable and meaningful — but it is not `evaluator/cacti`'s `area_mm2` or anything
