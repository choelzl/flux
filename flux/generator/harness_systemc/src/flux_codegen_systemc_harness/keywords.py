...
#: both harnesses, and only the WORD SET is language-specific -- a Verilog spec may legally use
#: identifiers C++ reserves, and the reverse.
check_not_reserved = reserved_check(
    CPP_RESERVED_WORDS, language="C++ keyword or SystemC macro/type", tool="g++",
    decision="D55, mirroring D51")


__all__ = ["CPP_RESERVED_WORDS", "check_not_reserved"]
