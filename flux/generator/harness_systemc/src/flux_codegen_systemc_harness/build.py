...
recipe `evaluator/systemc` already uses successfully in this environment.
...
symbol clash. `generate_systemc_module` (interfaces/chia_nodes) is responsible for prompting the LLM
...
from flux_codegen_harness_spec import HarnessRunResult  # the shared shape (D453)
