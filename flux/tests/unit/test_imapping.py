...
from flux_imapping import (
    ...
    score, shared_cycle, swizzle_for, train_holdout, xbar_full,
)
from flux_bankmap.mapping import Modulo, XorFold
from imapping_fixtures import run_study     # the document, run the way `flux task run` runs it (R3)
...
def test_simulator_agrees_exactly_where_a_scheduler_cannot_help():
    """The confidence chain's middle stage (D394): on traffic with no scheduling
