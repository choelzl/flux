...
from flux_records.mining import FactStore, fact_id
...
def test_new_evidence_supersedes_the_old_statement(tmp_path):
    ...
    seq = store.begin_trial(
        ...
        workload_hash="wh", arch_hash="ah32", strategy_kind="grid", stage="rtl")
