...
existed as a package (`flux_records.mining`, D243/D297/D329) and was reachable only by writing
...
def test_mined_is_a_source_like_the_others():
    ...
    assert available_roles("knowledge") == ["digest", "mined", "sources"]        # D576 added digest and sources
