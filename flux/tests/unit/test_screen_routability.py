...
# -- the throughput stage must not answer for a fabric it cannot simulate ----------------------
...
def test_an_unroutable_fabric_gets_no_modelled_throughput():
    ...
    the only thing that ever contradicted it was the decision stage failing to place it.
    """
