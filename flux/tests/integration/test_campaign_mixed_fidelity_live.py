...
latency_cycles screened by ZigZag, area_mm2 measured only at the OpenROAD escalation stage —
...
def test_latency_and_silicon_area_compose_into_one_frontier(tmp_path):
    ...
    # the stage result legally omits latency — ok under escalation classification (D226)
...
def test_a_stop_target_on_the_deferred_metric_is_judged_against_the_composite(
    ...
    exhaustion. Both outcomes exercised against the real stage."""
    doc = {
        "schema_version": "0.1.0",
