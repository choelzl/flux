...
`evaluator/booksim/src/flux_evaluator_booksim/adapter.py`; the table above reflects the corrected
...
`nix shell nixpkgs#flex nixpkgs#bison`, see `evaluator/booksim/README.md`), and a working `g++`.
"""
