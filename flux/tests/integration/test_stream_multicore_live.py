...
def test_real_dual_core_architecture_runs_through_real_stream(evaluator):
    ...
    architecture_translator.py (reusing evaluator/zigzag's own existing per-core translator),
...
def test_reachable_through_the_generic_flux_evaluate_chia_node():
    """No dedicated CHIA node was added for Stream — same shape evaluator/gem5/thermal/dramsim3/
