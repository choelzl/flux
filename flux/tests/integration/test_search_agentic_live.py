...
`interfaces/chia_nodes/README.md` for the submodule gotcha), and `flux-evaluator-zigzag`.
"""
...
class _OllamaProposer:
    ...
    (docs/architecture.md's L5/L6 layering), matching how `interfaces/chia_nodes/parallel.py`'s
