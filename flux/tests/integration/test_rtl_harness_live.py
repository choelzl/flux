...
source is ever trusted to it (see interfaces/chia_nodes/generate_rtl.py, D44).

Requires real Verilator (`nix develop .#default`), the same toolchain `evaluator/rtl`'s own
