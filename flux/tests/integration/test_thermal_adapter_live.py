...
def test_zigzag_ignores_floorplan_and_power_w_entirely_a_real_different_quantity_not_a_rejection():
    ...
    The real reason this workload needs `evaluator/thermal` isn't that other evaluators reject
...
def test_chia_node_reaches_thermal_through_the_generic_flux_evaluate_registry():
    ...
    evaluator/gem5 already established: reachable through the generic flux_evaluate node once
