...
`evaluator/booksim/README.md` records the exact numbers a from-scratch build produced (62.8
...
def test_none_architecture_is_rejected(evaluator, workload):
    """Unlike evaluator/rtl/systemc, there's no fixed default NoC to fall back to."""
