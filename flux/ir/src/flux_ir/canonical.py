"""Canonicalisation and content-addressed hashing for Flux IR documents (docs/04.md §3.4)."""
...
def content_hash(doc: dict[str, Any]) -> str:
    ...
    downstream and the lineage key for everything upstream (docs/03.md G9, G10).
    """
