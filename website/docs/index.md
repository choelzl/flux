...
searches it with real tools (Verilator, Yosys, OpenROAD, ChampSim, z3, ...) on a chain of
...
measurement stage the report names, then the trade-off frontier, then what the run established,
...
chain of rising cost. The model holds *job titles* inside those roles -- proposer,
