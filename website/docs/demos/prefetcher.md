...
`params.invent_rounds: N` asks the model for N new prefetchers during a run, each challenged to beat the
...
`params.strategy: pareto-uct` replaces stage 1's hill-climb with a Pareto-UCT tree allocation
